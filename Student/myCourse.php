 ...
 <div class="container mt-2 ml-4">
  <div class="row">
   ...
   if(isset($stuLogEmail)){
    // $sql = "SELECT co.order_id, c.course_id, c.course_name, c.course_duration, c.course_desc, c.course_img, c.course_author, c.course_original_price, c.course_price FROM courseorder AS co JOIN course AS c ON c.course_id = co.course_id ";
    ...
    if($result->num_rows > 0) {
     while($row = $result->fetch_assoc()){ ?>
      <div class="bg mb-3",style="background-color:white">
