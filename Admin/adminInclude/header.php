...
<body>
 <!-- Top Navbar -->
 <nav class="nnavbar navbar-dark fixed-top p-0 shadow" style="background-color: #0c186e;">
  <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="adminDashboard.php">EnlightX <small class="text-white">Admin Panel</small></a> 
 </nav>
